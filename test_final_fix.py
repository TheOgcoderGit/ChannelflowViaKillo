...
assert ok1 and ok2
assert wallet_service.get_balance_inr(uid) == 100.0 - 0.20
...
assert abs(wallet_service.get_balance_inr(uid) - (100.0 - 0.20)) < 0.001
print('  Per-forward billing idempotency: OK')
...
assert not ok
print('  Insufficient balance check: OK')
